    ...
    <div className="overflow-x-auto bg-gray-800/70 p-4 sm:p-6 rounded-md shadow-xl backdrop-blur-md border border-gray-700/50">
      <Table className="min-w-full">
        ...
        <TableBody className="divide-y divide-gray-700">
          {trades.map((trade) => (
            <TableRow key={trade.id} className="hover:bg-gray-700/40 transition-colors">
              ...
              <TableCell className="py-3 px-4 whitespace-nowrap text-sm">
                {trade.tradingview_link ? (
                  <a href={trade.tradingview_link} target="_blank" rel="noopener noreferrer" className="text-purple-400 hover:text-purple-300 hover:underline">
                    Voir Graph.
                  </a>
                ) : '-'}
              </TableCell>
