...
export const AddTradeSchema = z.object({
  ...
  asset_id: z.string().uuid("L'actif sélectionné n'est pas valide."),
  session_id: z.string().uuid("La session sélectionnée n'est pas valide."),
  setup_id: z.string().uuid("Le setup sélectionné n'est pas valide."),
  ...
  tradingview_link: z.string().url("Le lien TradingView doit être une URL valide.").optional().or(z.literal('')),
